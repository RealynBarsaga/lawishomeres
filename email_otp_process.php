...
if (empty($error_message)) {
    ...
    try {
        ...
        <a href="http://lawishomeresidences.com/email_otp_verification?email=' . htmlspecialchars(stripslashes(trim($email))) . '&otp=' . htmlspecialchars(stripslashes(trim($otp))) . '">Click Here</a>
