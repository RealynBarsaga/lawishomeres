...
if (empty($error_message)) {
    ...
    try {
        ...
        <a href="https://lawishomeres.com/reset-password.php?code=' . htmlspecialchars(stripslashes(trim($code))) . '">Reset Password</a></p>';

        // Database connection is already established earlier using $con
