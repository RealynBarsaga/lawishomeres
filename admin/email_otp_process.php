        ...
        $mail->Body = '
            ...
            <body>
                <div class="email-container">
                    ...
                    <p><a href="http://localhost/mhrmsystem/admin/email_otp_verification.php?email=' . htmlspecialchars(stripslashes(trim($email))) . '&otp=' . htmlspecialchars(stripslashes(trim($otp))) . '" class="button" style="color: #fff;">Verify OTP</a></p>
