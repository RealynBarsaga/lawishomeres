...
function showForm(method) {
    ...
    if (method === 'email_link') {
        window.location.href = '../admin/email_link_form'; // Redirect to the email link form page
    } else if (method === 'email_otp') {
        window.location.href = '../admin/email_otp_form'; // Redirect to the email OTP form page
    }
}
