...
<body class="skin-black">
    ...
    <div class="header-section" style="margin-bottom: 30px;">
        ...
        <div class="col-xs-7 col-sm-6 col-md-8" style="text-align: center;margin-top: 30px;">
            <div style="font-size: 15px; font-family: 'Courier New', Courier;">
                <p style="margin-left: -180px;">Republic of the Philippines<br>
                Province of Cebu<br>
        ...
        <!-- Right Logo -->
        <div class="col-xs-4 col-sm-3 col-md-2" style="padding: 10px; float: right;margin-top: -109px;">
    ...
    <div style="text-align: center; margin-top: -84px;margin-left: -9px;"> <!-- Added margin-top to create space between image and text -->
        <span>
            <?php
    ...
    <!-- Image -->
    <img src="../../img/image1.png" alt="Image" style="margin-top: -59px;margin-left: -9px;">

    <!-- Text above the image -->
    <div style="text-align: center; margin-top: -77px;margin-left: -9px;"><!-- Added margin-top to create space between image and text -->
        <span>
        <?php
            // Fetching data from the database and displaying the Business ID
            $name = $_GET['resident'];
