...
<body class="skin-black">
    ...
    <div class="header-section" style="margin-bottom: 30px;">
        <!-- Left Logo -->
        <div class="col-xs-4 col-sm-3 col-md-2" style="padding: 15px; float: left;margin-top: 20px;">
        ...
        <!-- Right Logo -->
        <div class="col-xs-4 col-sm-3 col-md-2" style="padding: 15px; float: right;margin-top: -109px;">
