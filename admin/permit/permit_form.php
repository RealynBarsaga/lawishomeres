...
<body class="skin-black">
    ...
    <!-- Image -->
    <img src="../../img/image1.png" alt="Image" style="margin-top: -62px;margin-left: -9px;">

    <!-- Text above the image -->
    <div style="text-align: center; margin-top: -79px;margin-left: -9px;"><!-- Added margin-top to create space between image and text -->
        <span>
        <?php
            // Fetching data from the database and displaying the Business ID
            $name = $_GET['resident'];
