                ...
                <div class="row">
                    <div class="box">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <br>
                            <div class="info-box" style="margin-left: -10px; background-color: <?= $box['color'] ?> !important;box-shadow: 2px 5px 9px #888888;">
                                <span style="background: transparent; position: absolute; top: 47%; left: 73%; transform: translate(-50%, -50%); font-size: 40px; color: #eeeeeeba; z-index: 1;">
