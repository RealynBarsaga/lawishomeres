...
.info-box {
    ...
    background: #fff;
    width: 22%; /* Adjust width for better alignment */
    box-shadow: 0 1px 1px rgba(0, 0, 0, 0.1);
...
.info-box-footer {
    ...
    text-align: center;
    cursor: pointer;
    border-radius: 4px; /* Rounded footer */
    width: 100%;
}

/* Responsive Grid Layout for Info Boxes */
.row {
    display: flex;
    flex-wrap: wrap; /* Allows tiles to wrap on smaller screens */
    justify-content: space-between; /* Even spacing between tiles */
    margin: 0 auto; /* Center align */
}

/* Ensures Charts and Boxes Fit Responsively */
.chart-wrapper {
    display: flex;
    flex-wrap: wrap;
    gap: 15px;
    justify-content: center; /* Center charts */
    margin: 15px auto; /* Spacing around charts */
}

.chart-container,
.chart-containers,
.chart-contain {
    width: calc(48% - 10px); /* Responsive width for charts */
