...
<body class="skin-black">
    ...
    <div class="col-xs-4 col-sm-6 col-md-3" style="margin-top: 20px;background: white; margin-left:50px; border: 1px solid black;width: 200px;height:620px;">
    ...
    <div class="main-content col-xs-12 col-md-12">
        ...
        <?php
          ...
          if ($row = mysqli_fetch_array($squery)) {
            echo '
              <strong style="margin-top: -350px;font-size: 17px; margin-left: 350px;">'.strtoupper($row['Name']).'</strong><br>
        ...
        <p style="text-align: center;">
            <?php
                ...
                while($row = mysqli_fetch_array($qry)){
                    if($row['sPosition'] == "Captain"){
                        echo '
                        <strong style="font-size: 20px; margin-left: 40px;">HON.'.strtoupper($row['completeName']).'</strong>
                        <hr style="border: 0.1px solid black; width: 70%; margin-left: 65px;margin-top: -10px;"/>
