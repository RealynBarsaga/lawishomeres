                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input  id="txt_members" name="txt_members" class="form-control input-sm" value="' . htmlspecialchars($row['membersname'], ENT_QUOTES, 'UTF-8') . '" readonly style="height: 100px; overflow-y: auto;"/>
                            </div>
                            <div class="form-group">
