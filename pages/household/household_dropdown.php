...
if (isset($_POST['hof_id']) && isset($_POST['barangay'])) {
    ...
    $query = mysqli_query($con, "SELECT * FROM tbltabagak WHERE householdnum = (SELECT householdnum FROM tbltabagak WHERE id = '$hof_id') AND barangay = '$barangay' AND role != 'Members'");
