...
if(isset($_POST['btn_add'])){
    ...
    $txt_totalmembers = htmlspecialchars(stripslashes(trim($_POST['txt_totalmembers'])), ENT_QUOTES, 'UTF-8');
    ...
    $txt_members = htmlspecialchars(stripslashes(trim($_POST['txt_members'])), ENT_QUOTES, 'UTF-8');
