...
<body class="skin-black">
    ...
    <div class="main-content col-xs-12 col-md-12">
        ...
        <p class="text-center" style="font-size: 20px; font-weight: bold; margin-left: 100px;margin-top:-745px;">
            <b style="font-size: 23px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BARANGAY CERTIFICATION</b>
        </p><br>
        ...
        <?php
            ...
            if ($row = mysqli_fetch_array($squery)) {
                ...
                <strong>" . $row['age'] . "</strong> years old, <strong>" . $row['civilstatus'] . "</strong> Filipino citizen and a resident of Purok " . $row['purok'] . ", Barangay " . $row['barangay'] . ", 
                Madridejos, Cebu. A qualified availed of Republic Act 1261 Or the First Time Job Seeker Act of 2019.
                <br>
                <br>
                &nbsp;&nbsp;&nbsp;I futher that the holder/bearer was informed of his/he rights signed and responsibilities accord by Republic Act 11261 thought Oath of Understanding he/she signed and executed in the presence of our Barangay Hall.</p>";
            }
        ?>
        </p>
        <br>
        <p>
            ...
            if ($row = mysqli_fetch_array($squery)) {
                echo "<p style='font-family: \"Courier New\", Courier, monospace; text-align: justify; font-size: 15px;margin-left: 220px;margin-right: 60px;'>
                    &nbsp;&nbsp;&nbsp;This certification issued upon the request of above-named person in connection with his/her personal identification for <strong>" .  strtoupper($row['purpose']) . "</strong> purposes this may serve him/her best.</p>";
            }
            ?> 
        </p>
        <br>
    ...
    <div class="col-xs-offset-6 col-xs-5 col-md-offset-6 col-md-4">
        <p style="text-align: center;margin-top: -160px; margin-left:-385px;">
