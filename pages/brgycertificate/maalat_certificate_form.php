...
<body class="skin-black">
    ...
    <div class="col-xs-4 col-sm-6 col-md-3" style="margin-top: 10px;background: white; margin-left:50px; border: 1px solid black;width: 200px;height:720px;">
    ...
    <div class="main-content col-xs-12 col-md-12">
        <br><br>
        <p class="text-center" style="font-size: 20px; font-weight: bold; margin-left: 100px;margin-top:-767px;">
            <b style="font-size: 23px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BARANAGAY CERTIFICATION</b>
        </p><br>
