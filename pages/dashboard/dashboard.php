...
canvas {
    ...
    height: 95% !important; /* Ensure the canvas fills the container */
            ...
            <div class="row">
                <div class="box">
                    ...
                    $info_boxes = [
                        ...
                        ['label' => 'Total Residency', 'icon' => 'fa-file', 'color' => '#f39c12', 'query' => "SELECT * FROM tblrecidency WHERE barangay = '$off_barangay'", 'link' => '../certofresidency/certofres', 'style' => 'width: 120%;'],
                        ['label' => 'Total Indigency', 'icon' => 'fa-file', 'color' => '#d9534f', 'query' => "SELECT * FROM tblindigency WHERE barangay = '$off_barangay'", 'link' => '../certofindigency/certofindigency', 'style' => 'width: 120%;'],
                        ['label' => 'Total Brgy Certificate', 'icon' => 'fa-file', 'color' => '#5bc0de', 'query' => "SELECT * FROM tblcertificate WHERE barangay = '$off_barangay'", 'link' => '../brgycertificate/brgycertificate', 'style' => 'width: 120%;'],
                    ];
