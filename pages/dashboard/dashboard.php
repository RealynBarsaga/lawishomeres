...
// Get the total number of puroks for the current barangay
$total_puroks = isset($puroks[$off_barangay]) ? count($puroks[$off_barangay]) : 0;
                    ...
                    $info_boxes = [
                        ...
                        ['label' => 'Total Purok', 'icon' => 'fa-users', 'color' => '#ff851b', 'query' => "SELECT * FROM tbltabagak WHERE barangay = '$off_barangay'", 'link' => '../resident/resident', 'total' => $total_puroks],
                    ];
