...
<?php
   ...
   // Check if the user has the correct role (admin in this case)
    else (isset($_SESSION['userid']) && $_SESSION['role'] !== 'Administrator') {
            ...
            <div class="row">
                <div class="box">
                    ...
                    $info_boxes = [
                        ...
                        ['label' => 'Total Residency', 'icon' => 'fa-file', 'color' => '#f39c12', 'query' => "SELECT * FROM tblrecidency WHERE barangay = '$off_barangay'", 'link' => '../certofresidency/certofres.php?page=certofresidency'],
                        ['label' => 'Total Indigency', 'icon' => 'fa-file', 'color' => '#d9534f', 'query' => "SELECT * FROM tblindigency WHERE barangay = '$off_barangay'", 'link' => '../certofindigency/certofindigency.php?page=certofindigency'],
                        ['label' => 'Total Brgy Certificate', 'icon' => 'fa-file', 'color' => '#5bc0de', 'query' => "SELECT * FROM tblcertificate WHERE barangay = '$off_barangay'", 'link' => '../brgycertificate/brgycertificate.php?page=brgycertificate'],
                    ];
