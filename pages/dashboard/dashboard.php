        ...
        <section class="content">
            <div class="row">
                <div class="box">
                    ...
                    // Count the number of puroks for the selected barangay
                    $total_purok = isset($puroks[$off_barangay]) ? count($puroks[$off_barangay]) : 0;
                    ...
                    $info_boxes = [
                        ...
                        // Updated Info Box for Total Purok with count
                        ['label' => 'Total Purok', 'icon' => 'fa-users', 'color' => '#ff851b', 'count' => $total_purok, 'link' => '../purok/purok'],
                    ];
