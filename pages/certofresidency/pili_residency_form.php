...
<body class="skin-black">
    ...
    <div class="main-content col-xs-12 col-md-12">
        ...
        <p class="text-center" style="font-size: 20px; font-weight: bold; margin-left: 100px;margin-top:-745px;">
            <b style="font-size: 23px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CERTIFICATE OF RESIDENCY</b>
        </p><br>
        ...
        <?php
            ...
            if ($row = mysqli_fetch_array($squery)) {
                ...
                <strong>" . $row['age'] . "</strong> years old, <strong>" . $row['civilstatus'] . "</strong>, is a bona fide resident of Purok " . $row['purok'] . ", Barangay " . $row['barangay'] . ", 
                Madridejos, Cebu he is personally known to me. was born on " . date('F', strtotime($row['bdate'])) . "/" . date('j', strtotime($row['bdate'])) . "/" . date('Y', strtotime($row['bdate'])) . ".</p>";
            }
        ?>
        </p>
        <br>
        <p>
            ...
            if ($row = mysqli_fetch_array($squery)) {
                echo "<p style='font-family: \"Courier New\", Courier, monospace; text-align: justify; font-size: 15px;margin-left: 220px;margin-right: 60px;'>
                    &nbsp;&nbsp;&nbsp;This certification is being issued upon the request of <strong>" .  strtoupper($row['Name']) . "</strong> for <strong>" .  strtoupper($row['purpose']) . "</strong> purposes that may serve him/her best.</p>";
            }
            ?> 
        </p>
        <br>
    ...
    <div class="col-xs-offset-6 col-xs-5 col-md-offset-6 col-md-4">
        <p style="text-align: center;margin-top: -100px; margin-left:-350px;">
            ...
            <?php
                ...
                while($row = mysqli_fetch_array($qry)){
                    if($row['sPosition'] == "Secretary"){
                        echo '
                        <strong style="font-size: 17px; margin-left: 30px;">'.strtoupper($row['completeName']).'</strong>
                        <hr style="border: 0.1px solid black; width: 55%; margin-left: -90px;margin-top: -15px;"/>
                        <p style="margin-left: -73px; margin-top: -20px;">Barangay Secretary</p>
                        ';
                    }
                }
            ?>
