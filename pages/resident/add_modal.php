                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    <label class="control-label">Name: <span style="color:gray; font-size: 10px;">(Lastname Firstname, Middlinitial ,Extensionname)</span></label><br>
                                    <div class="col-sm-4">
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_image" id="txt_image" class="form-control input-sm" type="file" accept=".jpg, .jpeg, .png" required/>
